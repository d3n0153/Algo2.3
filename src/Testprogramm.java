...
class Testprogramm {
	...
	// Eine ungewÃ¶hnliche Implementierung des Graphen 0 <-> 1
    ...
    // (Bei den Algorithmen mst, bell und dijk muss ein gewichteter
	...
	// GewÃ¼nschten Algorithmus ausfÃ¼hren
	...
	case "mst":
	    MST mst = new MSTImpl();
	    if (!mst.compute((WeightedGraph)graph, s)) {
		System.out.println("disconnected graph");
		return;
	    }
	    for (int v = 0; v < n; v++) {
		print(v, "pred", mst.pred(v));
	    }
	    break;
	case "bell":
	case "dijk":
